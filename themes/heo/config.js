const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到zengg的AI博客空间', url: 'https://www.zenggtech.com' },
    // { title: '访问文档中心获取更多帮助', url: 'https://docs.tangly1024.com' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享AI知识',
  HERO_TITLE_2: '探索AI落地场景',
  HERO_TITLE_3: 'ZENGGTECH.COM',
  HERO_TITLE_4: 'zengg',
  HERO_TITLE_5: 'AI改变世界,尽情努力探索',
  HERO_TITLE_LINK: 'https://www.zenggtech.com',
  ...
  SOCIAL_CARD_URL: 'https://www.zenggtech.com',
