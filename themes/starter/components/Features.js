          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
              <div className='wow fadeInUp group mb-12' data-wow-delay='.1s'>
                <div className='mb-10'>
                  <img
                    src={siteConfig('STARTER_FEATURE_1_ICON')}
                    alt={siteConfig('STARTER_FEATURE_1_TITLE_1')}
                    className='w-10 h-10'
                  />
                </div>
                ...
                <h5 className='mb-2 text-lg font-bold text-dark dark:text-white'>
                  {siteConfig('STARTER_FEATURE_1_TITLE_2')}
                </h5>
            ...
            <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
              <div className='wow fadeInUp group mb-12' data-wow-delay='.15s'>
                <div className='mb-10'>
                  <img
                    src={siteConfig('STARTER_FEATURE_2_ICON')}
                    alt={siteConfig('STARTER_FEATURE_2_TITLE_1')}
                    className='w-10 h-10'
                  />
                </div>
                <h4 className='mb-3 text-xl font-bold text-dark dark:text-white'>
                ...
                <h5 className='mb-2 text-lg font-bold text-dark dark:text-white'>
                  {siteConfig('STARTER_FEATURE_2_TITLE_2')}
                </h5>
                <p className='mb-8 text-body-color dark:text-dark-6 lg:mb-9'>
            ...
            <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
              <div className='wow fadeInUp group mb-12' data-wow-delay='.2s'>
                <div className='mb-10'>
                  <img
                    src={siteConfig('STARTER_FEATURE_3_ICON')}
                    alt={siteConfig('STARTER_FEATURE_3_TITLE_1')}
                    className='w-10 h-10'
                  />
                </div>
                <h4 className='mb-3 text-xl font-bold text-dark dark:text-white'>
                ...
                <h5 className='mb-2 text-lg font-bold text-dark dark:text-white'>
                  {siteConfig('STARTER_FEATURE_3_TITLE_2')}
                </h5>
                <p className='mb-8 text-body-color dark:text-dark-6 lg:mb-9'>
            ...
            <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
              <div className='wow fadeInUp group mb-12' data-wow-delay='.25s'>
                <div className='mb-10'>
                  <img
                    src={siteConfig('STARTER_FEATURE_4_ICON')}
                    alt={siteConfig('STARTER_FEATURE_4_TITLE_1')}
                    className='w-10 h-10'
                  />
                </div>
                <h4 className='mb-3 text-xl font-bold text-dark dark:text-white'>
                ...
                <h5 className='mb-2 text-lg font-bold text-dark dark:text-white'>
                  {siteConfig('STARTER_FEATURE_4_TITLE_2')}
                </h5>
                <p className='mb-8 text-body-color dark:text-dark-6 lg:mb-9'>
