...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到zengg的AI博客空间!这里是我分享AI技术见解和探索的地方,会持续推出AI前沿技术解析、行业应用案例、开发实践教程等高质量原创内容',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'zengg', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个深度思考的AI探索者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zenggtech.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI,Chatgpt,人工智能,zengg,zenggtech,博客', // 网站关键词 英文逗号隔开
